...
<div class="container vh-calc d-flex flex-column align-items-center justify-content-center mb-5 mb-md-0">
    <form action="<?php $_SERVER['PHP_SELF']?>" method="post"
        ...
        <div class="intro">
            <h4>Añadir médico</h4>
            <p>Rellena los siguientes campos para proceder con el registro del médico en el sistema:</p>
        </div>
        <div class="campos container px-0 mt-2">
            ...
            <div class="row mb-3 g-3">
                <div class="col">
                    <div class="inputEmail d-flex flex-column">
                        ...
                        <input type="text" name="specialty" id="inputEspecialidad" placeholder="Especialidad"
                               class="px-2 border-form-control rounded mt-2 py-2" required>
                    </div>
                </div>
                <div class="col">
                    <div class="inputTelefono d-flex flex-column">
                        <label for="inputTelefono">Consulta</label>
                        <input type="text" name="office" id="inputConsulta" placeholder="Consulta"
                               class="px-2 border-form-control rounded mt-2 py-2" required>
                    </div>
                </div>
            </div>
            <div class="row mb-3 g-3">
                <div class="col">
                    <div class="inputEmail d-flex flex-column">
                        <label for="inputEmail">Usuario de acceso</label>
                        <input type="text" name="username" id="inputUsuario" placeholder="Usuario"
                               class="px-2 border-form-control rounded mt-2 py-2" required>
                    </div>
                </div>
                <div class="col">
                    <div class="inputTelefono d-flex flex-column">
                        ...
                        <input type="text" name="password" id="inputContrasena" placeholder="Contraseña"
                               class="px-2 border-form-control rounded mt-2 py-2" required>
                    </div>
                </div>
            </div>
        ...
        <div class="container siguiente d-flex justify-content-center justify-content-md-end align-items-end mt-5">
            <button type="submit" name="submit" class="btn btn-primary text-light">Añadir</button>
        </div>
        <?php if (isset($_SESSION['error_register_doctor_missing'])) { ?>
        ...
        <?php } unset($_SESSION['error_register_doctor_missing']) ?>
        <?php if (isset($_SESSION['error_register_doctor_username'])) { ?>
            <!-- Warning alert para register fallido -->
            <div class="alert alert-danger d-flex align-items-center mt-3 gap-3 w-100" role="alert">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                     class="bi bi-exclamation-triangle-fill" viewBox="0 0 16 16">
                ...
                <div>
                    Error. El nombre de usuario ya está en uso. Utiliza un nombre de usuario diferente.
                </div>
            </div>
        <?php } unset($_SESSION['error_register_doctor_username']) ?>
    </form>
</div>
