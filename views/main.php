...
<head>
    ...
    <!-- Google Fonts para descargar Roboto -->
...
<div class="container-fluid border-top">
    <footer class="container-fluid pt-4 col-lg-11">
        <div class="row">
            <div class="col-md-3 mb-3 d-flex flex-column justify-content-center">
                <p>Puedes encontrarnos en nuestras redes sociales y ver lo más actual de nuestro centro de
                    salud:</p>
                <div class="socialmedia d-flex gap-3">
                    <a href="https://www.facebook.com" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                    ...
                    <a href="https://www.instagram.com" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                    ...
                    <a href="https://www.linkedin.com" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                    ...
                    <a href="https://youtube.com" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="20"
            ...
            <div class="col-6 col-md-2 mb-3 offset-md-3">
                <?php if (!isset($_SESSION['is_logged_in'])) { ?>
                    <h5 class="pb-2">Nosotros</h5>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="<?php echo ROOT_URL . 'users/login' ?>"
                                                     class="nav-link p-0 text-body-secondary text-secondary">Iniciar sesión</a></li>
                        <li class="nav-item mb-2"><a href="<?php echo ROOT_URL . 'doctors' ?>"
                                                     class="nav-link p-0 text-body-secondary text-secondary">Reservar cita</a>
                        </li>
                        <li class="nav-item mb-2"><a href="<?php echo ROOT_URL . 'users/register' ?>"
                                                     class="nav-link p-0 text-body-secondary text-secondary">Registrarse</a>
                        </li>
                    </ul>
                <?php } ?>
            </div>
            ...
            <div class="col-6 col-md-2 mb-3">
                <h5 class="pb-2">Horario</h5>
                <ul class="nav flex-column text-secondary">
                    <li class="p-0 text-body-secondary">Lunes - Viernes:
                        08:00 a 21:00</li>
                    <li class="nav-item mb-2 p-0 text-body-secondary">(Urgencias 07:30
                        a 08:00)</li>
                    <li class="nav-item mb-2 p-0 text-body-secondary">Sábado - Domingo:
                        Cerrado</li>
                </ul>
            </div>
            ...
            <div class="col-6 col-md-2 mb-3">
                ...
                <ul class="nav flex-column text-secondary">
                    <li class="nav-item mb-2 p-0 text-body-secondary"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li class="nav-item mb-2 p-0 text-body-secondary"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        Nájera, 19, 26002 Logroño, La Rioja</li>
                </ul>
            </div>
        </div>

        <div class="d-flex flex-column flex-sm-row justify-content-between pt-4 mt-4 border-top">
            <p>Copyright © 2025 <strong>Logrosalud</strong>. Todos los derechos reservados.</p>
            <div>
