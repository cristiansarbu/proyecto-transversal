        ...
        <div class="row">
            <div class="col-md-3 mb-3 d-flex flex-column justify-content-center">
                ...
                <div class="socialmedia d-flex gap-3">
                    <a href="#" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="20"
            ...
            <div class="col-6 col-md-2 mb-3 offset-md-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="#"
                                                 class="nav-link p-0 text-body-secondary text-secondary">Inicio</a></li>
                    <li class="nav-item mb-2"><a href="#"
                    ...
                    <li class="nav-item mb-2"><a href="#"
                                                 class="nav-link p-0 text-body-secondary text-secondary">Información</a>
                    </li>
                </ul>
            </div>
